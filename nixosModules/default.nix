...
in
{
  options.services.elmonitorro = {
    ...
    subscriptionLimit = lib.mkOption {
      default = 20;
      example = 40;
      description = ""; # TODO
      type = lib.types.int;
    };
    filterLimit = lib.mkOption {
      default = 20;
      example = 40;
